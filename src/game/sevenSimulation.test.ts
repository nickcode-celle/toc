...
describe("seven sequential control", () => {
  it("can finish the fourth own marble then spend remaining points on teammate", () => {
    ...
    state.marbles = [finish("0-0", 0, 1), finish("0-1", 0, 2), finish("0-2", 0, 3), track("0-3", 0, 12), track("2-0", 2, 20), home("2-1", 2), home("2-2", 2), home("2-3", 2), home("1-0", 1), home("1-1", 1), home("1-2", 1), home("1-3", 1), home("3-0", 3), home("3-1", 3), home("3-2", 3), home("3-3", 3)];
  ...
  it("cannot use teammate before the fourth own marble is finished", () => {
    const state = createInitialGameState(); state.currentPlayer = 0;
    state.marbles = [finish("0-0", 0, 0), finish("0-1", 0, 1), track("0-2", 0, 5), track("0-3", 0, 12), track("2-0", 2, 20), home("2-1", 2), home("2-2", 2), home("2-3", 2), home("1-0", 1), home("1-1", 1), home("1-2", 1), home("1-3", 1), home("3-0", 3), home("3-1", 3), home("3-2", 3), home("3-3", 3)];
